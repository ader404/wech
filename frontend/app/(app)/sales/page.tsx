          ...
          {viewing && (
            <div className="space-y-4 mt-2">
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
                ...
                <span className="text-muted-foreground">Payment Status</span><span><Badge variant={PAYMENT_STATUS_VARIANTS[viewing.paymentStatus] || 'default'}>{viewing.paymentStatus}</Badge></span>
              </div>
              ...
              <div className="space-y-1 text-sm border-t pt-3">
                ...
                <div className="flex justify-between text-emerald-600"><span>Amount Paid</span><span>{formatCurrency(viewing.amountPaid)}</span></div>
                {viewing.amountDue > 0 && (
                  <div className="flex justify-between text-destructive font-medium"><span>Amount Due</span><span>{formatCurrency(viewing.amountDue)}</span></div>
                )}
              </div>
      ...
      <AlertDialog open={!!deleteConfirm} onOpenChange={() => setDeleteConfirm(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this sale? This action can be undone from the deleted sales view.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
